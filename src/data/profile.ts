export const profile = {
  ...
  delivered: [
    { value: 12, prefix: "", suffix: "", decimals: 0, label: "Years of experience" },
    { value: 4, prefix: "", suffix: "", decimals: 0, label: "Career stages" },
    { value: 8, prefix: "", suffix: "", decimals: 0, label: "Selected projects" },
    { value: 3, prefix: "", suffix: "", decimals: 0, label: "Core disciplines" },
  ],
  principles: [
